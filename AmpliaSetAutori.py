...
def ampliaSetAutori(pfPersone, pfAuthorRAW, pftAutoriID, pfPapAutAffRAW, pftPAA, pfAffRAW, regAff, pfAffPad):
  ...
  # print('id autori ampliati {}'.format(len(sAutAmpliati) ) )

  # scrivo gli id su un file
  # pfSoloIDautore = pftAutoriID.format('_ID_ampliato')
  ...
  pfAutoriIDampliati = pftAutoriID.format('_ampliato')
  ...
  # cerco e scrivo TUTTI i nomi, anche i coautori mai visti
  pfAutoriIDfiltrati = pftAutoriID.format('_filtrati')
  # estraiAutoriPerID(pfSoloIDautore, pfAuthorRAW, pfAutoriIDfiltrati)
...
def main():
  ...
  # print 'Completato ampliaSetAutori in {}'.format(end-start)
