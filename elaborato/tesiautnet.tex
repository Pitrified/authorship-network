...
L'algoritmo utilizzato per calcolare la \textit{V-measure} è
% \url{homogeneity_completeness_v_measure},
{\fontfamily{qcr}\selectfont \footnotesize homogeneity\_completeness\_v\_measure},
incluso nella libreria \textit{scikit-learn}
\cite{scikit-learn}.
