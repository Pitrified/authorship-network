...
Per il lavoro oggetto di questa tesi sono stati utilizzati in particolare quattro file del database, la cui struttura è illustrata nella tabella \ref{table:msrstruttura1}.
...
Per risolvere il secondo problema insorto nell'estrazione dei dati, sono state seguite due vie alternative fra loro.
...
% TODO scropri cosa fanno i self loop
